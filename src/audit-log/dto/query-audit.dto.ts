...
export class QueryAuditDto {
  ...
  @IsInt()
  @Min(1)
  @Max(10_000, { message: 'page não pode ultrapassar 10000.' })
  page?: number = 1;

  @ApiPropertyOptional({ description: 'Itens por página — máximo 100 (default: 20)', example: 20 })
  @IsOptional()
  @Type(() => Number)
  @IsInt()
  @Min(1)
  @Max(100, { message: 'limit não pode ultrapassar 100 (proteção contra sobrecarga).' })
  limit?: number = 20;
